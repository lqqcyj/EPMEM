        ...
        for line in f2:
            ...
            if question_id in question_map:
                ...
                if text_from_file1 == 'A':  
                    new_text = """Please focus on the main emotion conveyed by the image.
Which of the following emotions is represented in the image?
A. joy
B. love
C. surprise
Analyze and choose one option's letter from the given choices directly.
Format:
Analysis: <Analysis>
Choice: <choice>"""
...
Choice: <choice>"""
                    ...
                    new_text = f"""Please focus on the main emotion of the image.
Which of the following emotions is represented in the image?
A. joy
B. love
C. surprise
